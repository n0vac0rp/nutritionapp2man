...
export default function RatingDialog({ isOpen, onClose, userId, onRated }: RatingDialogProps) {
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader className="text-center">
            ...
            <DialogTitle className="text-2xl font-bold text-brand">Thank You!</DialogTitle>
          ...
          <div className="flex justify-center mt-6">
            <Button onClick={handleRated} className="px-8">
              Continue to App
            </Button>
          </div>
        </DialogContent>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="text-center">
          ...
          <DialogTitle className="text-2xl font-bold text-brand">Enjoying GluGuide?</DialogTitle>
          <DialogDescription>
